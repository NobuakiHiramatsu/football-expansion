...
@section('content')
    @if(Auth::check())
        <div id="main">
            {{-- ユーザデータ表示 --}}
            <p class="topic"><img src="image/icons8-soccer-ball-64.png" alt="soccerball">プロフィール</p>
            <div>
                <table class="table table">
                    ...
                    <tr>
                        <th class="text-center">favorite team</th>
                        <th class="text-left">
                            <p class="your_team"></p>
                            @if ($favorite)
                                <div class="fv_destroy">
                                    ...
                                    {!! Form::open(['route' => ['favorites.destroy', $favorite->id], 'method' => 'delete']) !!}
                                        ...
                                        {!! link_to_route('favorites.index', 'Favoriteへ', [], ['class' => 'btn btn-success btn-sm']) !!}
                                    {!! Form::close() !!}
