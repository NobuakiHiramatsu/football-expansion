...
$.getJSON(`https://api.football-data.org/v2/teams/${favorite_id}/`, function(data_ft){
    ...
    $(".your_team").append(
        `<p class="topic"><img src="image/icons8-soccer-ball-64.png" alt="soccerball">あなたのお気に入りチーム:<img src="https://crests.football-data.org/${data_ft.id}.svg" height="30" >${team_name}</p>`
    )
});
