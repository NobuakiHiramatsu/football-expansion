...
for(let i = 0; i < numbers.length; i++){
    ...
    //プレミアリーグの枠組み表示
    $(".PL_setsu").append(
        `<li class="nav-item"><a href="#PLmatch${numbers[i]}" class="nav-link setsu" data-toggle="tab">${numbers[i]}節</a></li>`
    )
    $(".PLmatches").append(
    ...
    //ラ・リーガの枠組み表示
    $(".PD_setsu").append(
        `<li class="nav-item"><a href="#PDmatch${numbers[i]}" class="nav-link setsu" data-toggle="tab">${numbers[i]}節</a></li>`
    )
    $(".PDmatches").append(
    ...
    //セリエAの枠組み表示
    $(".SA_setsu").append(
        `<li class="nav-item"><a href="#SAmatch${numbers[i]}" class="nav-link setsu" data-toggle="tab">${numbers[i]}節</a></li>`
    )
    $(".SAmatches").append(
